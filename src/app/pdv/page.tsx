...
export default function PDV() {
  ...
  const [mostrarCarrinho, setMostrarCarrinho] = useState(false); // 🔁 novo estado para modal
  ...
  const CarrinhoContent = (
    <div className="bg-white border p-6 rounded-lg shadow-md w-full max-w-md">
      {carrinho.length === 0 ? (
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-10 pb-10 px-6 max-w-6xl mx-auto relative">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        {/* Carrinho - sempre visível em telas md+ */}
